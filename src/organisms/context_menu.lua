...
-- HORIZONTE do poente — magenta -> laranja -> diáphano — e tinta ESCURA (v975), consoante
-- a regra da inversão sobre paradas claras (o magenta e o laranja o são; o violeta da
-- rampa não, por isso o horizonte da faixa PRINCIPIA no magenta). Serve de lemma
